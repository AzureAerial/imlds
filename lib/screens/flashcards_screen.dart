...
import 'dart:math';
import 'package:in_my_lane/widgets/background_scaffold.dart';  // Ensure this exists in your project
...
class _FlashcardsScreenState extends State<FlashcardsScreen> {
  final List<Map<String, dynamic>> _flashcards = [
    ...
    {'question': 'The posted speed limits show:', 'answer': 'The maximum safe speed under ideal road and weather conditions.'},
    {
      ...
      'answer': 'Wait for pedestrians and traffic.'
    },
    ...
    {
      'question': 'The car "B" is in the intersection, turning right on the red light. However, car "A" comes with a green light. Which of the car should yield?',
      'image': 'assets/s32.png',  // Local image
      'answer': 'Car "A" should yield to Car "B".'
    },
            ...
            children: <Widget>[
              ...
              if (currentFlashcard.containsKey('image'))
                Padding(
                  ...
                  child: Image.asset(
                    currentFlashcard['image']!,  // Load local image
                    height: 150,
