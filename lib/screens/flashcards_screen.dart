...
class _FlashcardsScreenState extends State<FlashcardsScreen> {
  final List<Map<String, dynamic>> _flashcards = [
    ...
    {'question': 'You are making a left turn from a two-way street into a multilane one-way street. When you have completed the turn, your car should be:', 'image': 'https://driver-start.com/images/questions/s38.svg', 'answer': 'In the left lane of the street.'},
    {'question': 'A red and white triangular sign at an intersection means:', 'image': 'https://driver-start.com/images/questions/s15.svg', 'answer': 'Slow down and be prepared to stop if necessary.'},
    ...
    {'question': 'In Michigan state if you are hauling a load which goes past the back of a vehicle by ______ feet, you must attach a red flag on the end of the load.', 'answer': '4 feet.'},
    ...
    {'question': 'What does this sign mean?', 'image': 'https://driver-start.com/images/questions/s40.svg', 'answer': '270-degree turn.'},
    ...
    {'question': 'This sign means that:', 'image': 'https://driver-start.com/images/questions/2_42.svg', 'answer': 'Workers are on or very close to the road in the work zone ahead.'},
    {'question': 'If your brake pedal suddenly sinks to the floor, you should first:', 'answer': 'Try to pump it to build up the pressure.'},
    {'question': 'This sign is used to warn drivers about:', 'image': 'https://driver-start.com/images/questions/s1.svg', 'answer': 'Lane ends, merge left.'},
    ...
    {'question': 'Suppose you are turning left into a driveway. What must you do before you continue?', 'image': 'https://driver-start.com/images/questions/s44.svg', 'answer': 'Wait for pedestrians and traffic.'},
    ...
    {'question': 'What does this sign mean?', 'image': 'https://driver-start.com/images/questions/s24.svg', 'answer': 'Sharp turn ahead.'},
    ...
    {'question': 'Which car is NOT using the circle correctly?', 'image': 'https://driver-start.com/images/questions/s30.svg', 'answer': 'C'},
    ...
    {'question': 'The car "B" is in the intersection, turning right on the red light. However, car "A" comes with a green light. Which of the car should yield?', 'image': 'https://driver-start.com/images/questions/s32.svg', 'answer': 'Car "A" should yield to Car "B".'},
    ...
    {'question': 'Which of these signs is used to show the end of a divided highway.', 'image': 'https://driver-start.com/images/questions/2_19.svg', 'answer': '2'},
    {'question': 'A reckless driver is a driver who:', 'answer': 'Drives with a willful and wanton disregard for the safety of others.'},
    {'question': 'Teenage drivers are more likely to be involved in a crash when:', 'answer': 'They are driving with teenage passengers.'},
    {'question': 'Drivers who eat and drink while driving _____:', 'answer': 'Have trouble controlling their vehicles.'},
    {'question': 'Before you leave a parking space that is parallel to the curb, you should:', 'answer': 'Look for traffic by turning your head.'},
    {'question': 'Assuming that the street is level, what should you do after you have finished parallel parking in a space between two other cars:', 'answer': 'Straighten your front wheels and leave room between cars.'},
    {'question': 'At dusk or on overcast days, you should:', 'answer': 'Turn on your headlights so other drivers can see your vehicle.'},
    {'question': 'Vehicle horns must be heard to:', 'answer': 'Warn other drivers of danger.'},
    {'question': 'What effect might alcohol and another drug have when combined in your blood?', 'answer': 'Increase the effects of both.'},
    {'question': 'When a driver passing you honks his horn, you should:', 'answer': 'Give him room to pass.'},
    {'question': 'How many minutes does the body need to process the alcohol in one drink for an average person?', 'answer': '60 minutes.'},
    {'question': 'Two cars are turning left at the intersection. By the rules, which of the cars is turning into the correct lane?', 'image': 'https://driver-start.com/images/questions/s38.svg', 'answer': 'Blue "B".'},
    {'question': 'Before you may get a learner’s license, you must:', 'answer': 'Pass the written test.'},
    {'question': 'If the rear of your vehicle starts to skid left, you should:', 'answer': 'Steer left.'},
  ];
  ...
  void _shuffleFlashcards() {
    setState(() {
      _flashcards.shuffle(Random());  // Shuffles the flashcards when the screen loads
    });
  }
            ...
            children: <Widget>[
              ...
              if (currentFlashcard.containsKey('image'))
                Padding(
                  ...
                  child: currentFlashcard['image'].toString().endsWith('.svg')
                    ? SvgPicture.network(
